      ...
      return(
        {
          ...
          shiftVectorCoefficients: e?.shift_vector_coefficients?.map(str => parseFloat(str)),
          pixelWavelengthCoefficients: e?.pixel_to_wavelength_coefficients?.map(str => parseFloat(str)),
